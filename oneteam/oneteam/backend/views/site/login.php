...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <script type="text/javascript" src="<?=$ad_src?>/common/js/jq.js"></script>
    <script type="text/javascript" src="<?=$ad_src?>/common/js/login.js"></script>
    <link href="<?=$ad_src?>/common/css/login2.css" rel="stylesheet" type="text/css" />
                    ...
                    <form action="" name="loginform" accept-charset="utf-8" id="login_form" class="loginForm" method="post">
                        ...
                        <div class="pwdArea" id="pwdArea">
                            <div class="inputOuter" id="pArea">
                                <input type="password" id="p" name="p" class="inputstyle" placeholder="密码"/>
                            </div>
                        </div>

                        <div id="cod" <?php if(isset(Yii::$app->session['error'])){echo "style='none'";}?>style="display: none">
                            <input type="text" id="code" class="inputstyle" placeholder="请输入验证码" style="width: 125px;float: left"/>
                            <img title="点击更换" src="<?=Url::toRoute('site/verify');?>" alt="CAPTCHA" onclick= this.src="<?=Url::toRoute('site/verify');?>?id="+Math.random() title="" id="gb_version" class="gb_version" style="cursor: pointer;" />
                        </div>
                        <div style="padding-left:50px;margin-top:20px;"><input type="button" value="登 录" id="btn" style="width:150px;" class="button_blue"/></div>
                    </form>
                </div>
            </div>
        </div>
